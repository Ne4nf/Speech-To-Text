...
- [ ] **Browser-Native First**: Web Speech API used for speech recognition (no backend services)
- [ ] **Progressive Enhancement**: Core MVP defined (speech recognition + note storage + display)
- [ ] **Privacy by Design**: No backend/telemetry/authentication required (data stays local)
- [ ] **Simplicity & YAGNI**: Minimal dependencies, direct Web Speech API usage, flat component structure
- [ ] **Accessibility First**: Keyboard navigation, ARIA labels, visual feedback, WCAG AA contrast
- [ ] **Specification-First**: Spec.md complete with prioritized user stories (P1, P2, P3)
